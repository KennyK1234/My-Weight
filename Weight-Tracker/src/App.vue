...
//   db.ref('weights').on('value', (snapshot) => {
//     const data = snapshot.val();
//     weights.value = data ? Object.values(data) : [];
//   });
// });
...
<template>
  <main>
		...
		<div class="inspiration">
			<h4>Take control of your health and well-being.</h4>
			<h4>Watch your body transform as you stay consistent.</h4>
		</div>
		<div class="current">
